...
const index = 2;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-29eT0yLQ.js')).default;
const universal = {
  "ssr": false,
  "load": null
};
